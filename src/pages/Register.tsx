...
export default function Register() {
  ...
  return (
    <>
      <Helmet>
        <title>Inscrire Mon École - Help Digi School</title>
        <meta 
          name="description" 
          content="Inscrivez votre école primaire sur Help Digi School. Essai gratuit 14 jours, configuration en 5 minutes." 
        />
      </Helmet>

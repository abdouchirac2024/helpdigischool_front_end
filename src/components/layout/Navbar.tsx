          ...
          <div className="hidden items-center gap-0.5 lg:flex">
            {navLinks.map((link) => {
              ...
              return (
                ...
                >
                  {isActive && <span className="absolute inset-0 rounded-xl bg-[#2302B3]/[0.08]" />}
            ...
            {isLoading ? (
              ...
              <DropdownMenu>
                ...
                >
                  ...
                  <DropdownMenuItem asChild>
                    <Link href={dashboardPath} className="flex cursor-pointer items-center gap-2.5">
              ...
              <>
                <Button
                  ...
                  size="sm"
                  asChild
                  className="hidden rounded-xl text-gray-600 hover:bg-gray-50 hover:text-[#2302B3] sm:flex"
                >
                ...
                <Button
                  size="sm"
                  asChild
                  className="rounded-xl bg-[#2302B3] text-white shadow-md shadow-[#2302B3]/25 transition-all duration-200 hover:bg-[#1a0285] hover:shadow-lg hover:shadow-[#2302B3]/30 active:scale-[0.97]"
                >

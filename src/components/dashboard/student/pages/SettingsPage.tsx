                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="relative mt-1.5">
                      ...
                      <Input id="email" type="email" defaultValue="amina.talla@eleve.cm" className="pl-10" />
                    </div>
                  </div>
                  <div>
            ...
            <TabsContent value="notifications" className="space-y-6">
              <div className="bg-white rounded-xl p-6 border border-gray-100">
                ...
                <div className="space-y-6">
                  {[
                    { title: 'Notifications par email', desc: 'Recevoir des emails pour les mises à jour', icon: Mail },
                    { title: 'Notifications push', desc: 'Recevoir des notifications sur ton appareil', icon: Bell },
                    { title: 'Nouvelles notes', desc: 'Être notifié quand une nouvelle note est publiée', icon: Award },
                    { title: 'Nouveaux devoirs', desc: 'Être notifié des nouveaux devoirs à rendre', icon: FileText },
                    { title: 'Rappels de devoirs', desc: 'Recevoir des rappels avant la date limite', icon: Calendar },

            ...
            <div>
              ...
              <div className="relative mt-1.5">
                ...
                <Input
                  id="email"
                  type="email"
                  defaultValue="s.mballa@lycee-yaounde.cm"
                  className="pl-10"
                />
              </div>
            </div>
          ...
          <div className="space-y-6">
            {[
              ...
              },
              {
                ...
                desc: "Être notifié des nouvelles demandes d'inscription",
                icon: UserPlus,
              },
              {
                title: 'Paiements reçus',
                desc: 'Confirmation des paiements enregistrés',
                icon: CreditCard,
              },
              { title: 'Rendez-vous', desc: 'Rappels de rendez-vous', icon: Calendar },
              {
                title: 'Documents générés',
                desc: 'Notification quand un document est prêt',
                icon: FileText,
              },
            ].map((item, i) => (
              <div

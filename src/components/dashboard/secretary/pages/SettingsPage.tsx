...
export function SecretarySettingsPage() {
        ...
        <ProfileSection
          extraFields={
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              <div>
                <Label htmlFor="settings-poste">Poste</Label>
                <Input
                  id="settings-poste"
                  defaultValue="Secretaire principale"
                  disabled
                  className="mt-1.5 bg-gray-50"
                />
              </div>
              <div>
                <Label htmlFor="settings-service">Service</Label>
                <Input
                  id="settings-service"
      ...
      content: (
        <div className="rounded-xl border border-gray-100 bg-white p-6">
          ...
          <div className="space-y-6">
            ...
            <div>
              <Label htmlFor="printFormat">Format d&apos;impression par defaut</Label>
  ...
  return <SharedSettingsPage role="secretary" sections={sections} />
}

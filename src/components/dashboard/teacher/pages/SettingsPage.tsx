            ...
            <div>
              ...
              <div className="relative mt-1.5">
                ...
                <Input
                  id="email"
                  type="email"
                  defaultValue="m.kouam@lycee-yaounde.cm"
                  className="pl-10"
                />
              </div>
            </div>
          ...
          <div className="space-y-6">
            {[
              ...
              },
              {
                ...
                desc: 'Confirmation après saisie des notes',
                icon: Award,
              },
              {
              ...
              },
              {
                ...
                desc: 'Recevoir des rappels avant les cours',
                icon: Calendar,
              },
              {
                title: 'Absences élèves',
                desc: 'Être notifié des absences non justifiées',
                icon: ClipboardList,
              },
            ].map((item, i) => (
              <div
